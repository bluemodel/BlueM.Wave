...
Partial Class AnnualStatistics_Dialog
    ...
    Private Sub InitializeComponent()
        ...
        CheckBox_boundingbox = New CheckBox()
        SuspendLayout()
        ' 
        ' Button_OK
        ' 
        ...
        Button_OK.Location = New Point(234, 69)
        ...
        ' 
        CheckBox_boundingbox.AutoSize = True
        CheckBox_boundingbox.Location = New Point(14, 38)
        CheckBox_boundingbox.Name = "CheckBox_boundingbox"
        CheckBox_boundingbox.Size = New Size(287, 19)
        CheckBox_boundingbox.TabIndex = 15
        CheckBox_boundingbox.Text = "Generate annual bounding boxes (max, avg, min)"
        CheckBox_boundingbox.UseVisualStyleBackColor = True
        ' 
        ...
        Controls.Add(CheckBox_boundingbox)
        ...
        MaximizeBox = False
        MinimizeBox = False
        Name = "AnnualStatistics_Dialog"
        ShowInTaskbar = False
        StartPosition = FormStartPosition.CenterParent
        Text = "AnnualStatistics"
        ResumeLayout(False)
        PerformLayout()
