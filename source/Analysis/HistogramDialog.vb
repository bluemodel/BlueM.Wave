...
Friend Class HistogramDialog
    ...
    Private Sub Paste_Click(sender As System.Object, e As System.EventArgs) Handles Button_paste.Click
        ...
        If (Not ClipboardContents.GetDataPresent(DataFormats.Text, True)) Then
            MsgBox("Unable to process clipboard contents!", MsgBoxStyle.Exclamation, "Warning")
            Exit Sub
        End If
    ...
    Private Sub OK_Button_Click(sender As System.Object, e As System.EventArgs) Handles OK_Button.Click
        ...
        If Me.breaks(n_breaks - 1) < Me.max Then
            MsgBox($"The last break is smaller than the maximum value!{eol}Please add a break greater than or equal to the maximum value of {Me.max.ToString("F")}", MsgBoxStyle.Exclamation, "Warning")
            Exit Sub
        End If

        'check that first break is not less than min
        If Me.DataGridView_breaks.Rows(0).Cells(1).Value < Me.min Then
            MsgBox($"The first break is smaller than the minimum value!{eol}Please enter only breaks that are greater than the minimum value of {Me.min.ToString("F")}", MsgBoxStyle.Exclamation, "Warning")
            Exit Sub
        End If
...
#Region "Events"
    ...
    Private Sub DataGridView_bins_DataError(sender As System.Object, e As System.Windows.Forms.DataGridViewDataErrorEventArgs) Handles DataGridView_breaks.DataError
        MsgBox("The entered value is not valid!", MsgBoxStyle.Critical, "Error")
    End Sub
