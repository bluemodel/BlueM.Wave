...
'
Friend Class AnnualRecurrenceProbability_Dialog
    ...
    Private Sub AnnualRecurrenceProbability_Dialog_Load(sender As Object, e As EventArgs) Handles MyBase.Load
