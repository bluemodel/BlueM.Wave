...
Public Class HystemExtran_WEL
    ...
    Private AnzZeilen_dT As Integer
...
#Region "Methoden"
    ...
    Public Overrides Sub SpaltenAuslesen()
        ...
        Try
            ...
            AnzZeilen_dT = Math.Ceiling(anzSpalten / maxSpalten_dT)
            ReDim AnzSpalten_dT(AnzZeilen_dT - 1)
            If AnzZeilen_dT = 1 Then
                AnzSpalten_dT(AnzZeilen_dT - 1) = anzSpalten
            ElseIf AnzZeilen_dT > 1 Then
                For i = 0 To AnzZeilen_dT - 2
                    AnzSpalten_dT(i) = maxSpalten_dT
                Next
                AnzSpalten_dT(AnzZeilen_dT - 1) = anzSpalten - (maxSpalten_dT * (AnzZeilen_dT - 1))
            End If

            'Spaltenköpfe (Zuflussknoten) und Indizes einlesen
            Dim index As Integer
            index = 1
            For i = 0 To AnzZeilen_dT - 1
                Zeile = StrReadSync.ReadLine.ToString()
            ...
            Me.iZeileDaten = iZeileUeberschriften + AnzZeilen_dT
